      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base">
              Bringing you the coziest and most stylish hoodies since 2023.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link href="/bestsellers" className="text-base text-gray-500 hover:text-gray-900">
                      Bestsellers
                    </Link>
                  </li>
                  <li>
        ...
        <div className="mt-12 border-t border-gray-300 pt-2">
          <p className="text-base text-gray-500 xl:text-center">
            &copy; 2023 Hoodie Co. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
